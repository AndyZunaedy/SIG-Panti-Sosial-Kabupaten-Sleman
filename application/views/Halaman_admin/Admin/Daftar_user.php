                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a>Verifikasi Daftar User</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<div class="card">
                    ...
                    <form action="<?= base_url('admin/daftar_user/') ?>" method="POST">
                                    ...
                                    <?php foreach ($user_admin as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href=" <?php echo site_url('admin/update_daftar/' . $crud->id_admin) ?>" class="btn btn-small"><i class="ti-unlock"></i>Aktifkan</a>
