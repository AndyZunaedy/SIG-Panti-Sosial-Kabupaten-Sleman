                                ...
                                <tbody>
                                    <?php foreach ($data_penghuni as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#modaltampil<?php echo $id_komen; ?>" class="btn btn-small"><i class="ti-marker-alt"></i>Balas Komentar</a>
