                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Verifikasi Data Galeri Panti</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                                    ...
                                    <?php foreach ($data_galeri as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('admin/update_galeri_aktif/' . $crud->id_galeri) ?>" class="btn btn-small"><i class="ti-marker-alt"></i>Verifikasi</a>


                                                <a href="<?php echo site_url('admin/hapus_galeri_verifikasi/' . $crud->id_galeri) ?>" class="btn btn-small text-danger" onclick="return confirm(' Yakin menghapus data ini?');"><i class="ti-trash"></i> Hapus</a>
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-6"><?= $crud->keterangan ?></dd>
                                </dl>
