<div class="pcoded-content">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Verifikasi Data Kegiatan Panti</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
 ...
 <div class="card">
                    ...
                    <form action="<?= base_url('admin/verifikasi_kegiatan/') ?>" method="POST">
                ...
                <div class="card">
                    ...
                    <form action="<?= base_url('admin/kegiatan/') ?>" method="POST">
                        <div class="pcoded-search col-lg-6 mb-2 mt-2">
                            <span class="searchbar-toggle"> </span>
                                    ...
                                    <?php foreach ($data_kegiatan as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('admin/update_kegiatan_aktif/' . $crud->id_kegiatan) ?>" class="btn btn-small"><i class="ti-marker-alt"></i>Verifikasi</a>

                                                <a href="<?php echo site_url('admin/hapus_kegiatan_verifikasi/' . $crud->id_kegiatan) ?>" class="btn btn-small text-danger" onclick="return confirm(' Yakin menghapus data ini?');"><i class="ti-trash"></i> Hapus</a>
