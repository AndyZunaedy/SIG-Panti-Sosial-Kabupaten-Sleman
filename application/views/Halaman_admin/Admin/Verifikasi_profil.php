    ...
    <div class="pcoded-inner-content">
        ...
        <div class="main-body">
            <div class="page-wrapper">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Verifikasi Data Profil Panti</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                ...
                <!-- Page-header end -->
 <div class="card">
                <form action="<?= base_url('admin/verifikasi_profil/') ?>" method="POST">
                                    ...
                                    <?php foreach ($data_profil as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('admin/update_profil_aktif/' . $crud->id_profil) ?>" class="btn btn-small"><i class="ti-marker-alt"></i>Verifikasi</a>


   <a href="<?php echo site_url('admin/hapus_panti_verifikasi/' . $crud->id_profil) ?>" class="btn btn-small text-danger" onclick="return confirm('Yakin menghapus data ini?');"><i class="ti-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-6"><?= $crud->deskripsi ?></dd>
                                </dl>
