<div class="pcoded-content">
            ...
            <div class="page-wrapper">
                ...
                <div class="card">
                    <div class="card-header">
                        <span> <a href="<?= base_url('admin/formkegiatan'); ?>"><i class="ti-plus"></i> Tambah Kegiatan</a></span>
                    </div>
 ...
 <td>
                                                <?php echo $crud->aktifasi_kegiatan == 0 ? "Belum diverifikasi" : "Terverifikasi"  ?>
                                            </td>
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#modaltampil<?php echo $id_kegiatan; ?>" class="btn btn-small"><i class="ti-eye"></i>Detail</a>
                                                <a href=" <?php echo site_url('admin/formedit_kegiatan/' . $crud->id_kegiatan) ?>" class="btn btn-small"><i class="ti-marker-alt"></i> Edit</a>
