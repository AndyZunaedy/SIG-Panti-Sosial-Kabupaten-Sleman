            ...
            <div class="page-wrapper">
                ...
                <div class="card">
                    <div class="card-header col-lg-4">
                        <div class="row">
                            <div class="col-lg-4">
                                <span> <a href="<?= base_url('admin/form_tambah_panti'); ?>"><i class="ti-plus"></i> Tambah Profil</a></span>
                            </div>
                            ...
                            <input name="search" type="submit" value='Cari'>
                                ...
                                <div class="pcoded-search-box col-lg-1 mt-2">
                                    <?php foreach ($id_admin as $crud) :
                                        $id_admin = $crud->name; ?>
                                        <span> <a href="<?= base_url('admin/print_profil_semua/' .  $id_admin); ?>"><i class=" ti-printer"></i> Cetak</a></span>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <tbody>
                                    <?php foreach ($data_profil as $crud) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $crud->aktifasi_profil == 0 ? "Belum diverifikasi" : "Terverifikasi"  ?>
                                            </td>

                                            <td>
                                                <a href="<?= base_url('admin/print_profil/' .  $id_profil); ?>" class="btn btn-small"><i class=" ti-printer"></i> Cetak</a>
                                                <a href="#" data-toggle="modal" data-target="#modaltampil<?php echo $id_profil; ?>" class="btn btn-small"><i class="ti-eye"></i>Detail</a>
                                                <a href="<?php echo site_url('admin/formedit/' . $crud->id_profil) ?>" class="btn btn-small"><i class="ti-marker-alt"></i>Edit</a>
