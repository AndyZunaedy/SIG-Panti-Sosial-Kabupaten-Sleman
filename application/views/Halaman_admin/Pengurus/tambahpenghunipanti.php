                        ...
                        <div class="col-lg-6">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('admin/tambahpenghuni'); ?>">Form Tambah Penghuni Panti</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-header-text">Form Tambah Penghuni Panti</h5>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('admin/tambahpenghuni'); ?>" enctype="multipart/form-data">
